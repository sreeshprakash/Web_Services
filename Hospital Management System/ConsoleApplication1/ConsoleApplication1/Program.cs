...
namespace WordCount
{
    class MainClass
    {
        ...
        {
            Console.WriteLine("Counting words... Please Wait");
            ...
            if (args.Length == 0)
            {
                args = new string[] { "C:\\Users\\user\\Downloads\\go.txt" };
            }
            ...
            Console.WriteLine("Completed Processing in {0} secs", new TimeSpan(stop_at.Ticks - start_at.Ticks).TotalSeconds);
            Console.WriteLine();
            Console.WriteLine("The top 10 commonly used words in the file are:");
            ...
            Console.WriteLine();
            Console.WriteLine("{0} total words found", total_word_count);
